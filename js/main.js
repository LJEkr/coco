$(function(){
    ...
    //close_btn을 클릭하면 sitemap영역이 사라짐
    ...
    //mo_close를 클릭하면 mo_menu영역이 사라짐
        ...
        $('.mo_nav > ul > li').click(function(){
            //만약 클릭한 메뉴에 액티브가 설정되어 있지 않다면
            if($(this).attr('class') != 'active'){
                //mo_nav의 모든 주메뉴에서 액티브 클래스 제거
    ...
    if(winWidth>=1600){
        ...
        $('#fullpage').fullpage({
            ...
            navigationTooltips:['MAIN','BENEFITS','COURSE','TICKET'],
        ...
        //mo_box 슬라이드
        //var mo_width=$('.mo_box ul li').width();
